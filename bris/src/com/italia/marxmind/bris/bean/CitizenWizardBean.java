...
@ManagedBean(name="citBean", eager=true)
@ViewScoped
public class CitizenWizardBean implements Serializable{
	...
	private List<String> shots = Collections.synchronizedList(new ArrayList<>());
	private List civils = Collections.synchronizedList(new ArrayList<>());
	...
	public void saveButton() {
			...
			if(cit!=null && Login.getUserLogin().checkUserStatus()) {
				
				if(cit.getCustomerid()==0) {
