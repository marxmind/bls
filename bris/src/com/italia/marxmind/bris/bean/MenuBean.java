...
public class MenuBean implements Serializable{
	...
	public void init(){
		...
		//runReport(); this code move in loginBean
		loadCountEmailNote();
	...
	private void runReport() {
		...
		System.out.println("Reexecute run report....");
		Runtime.getRuntime().exec(pathFile +  "bris-report.jar");
		System.out.println("End Reexecute run report....");
