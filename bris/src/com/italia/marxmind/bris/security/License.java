...
public class License {
	...
	private static void updateLicense(Module moduleName, String licenseKey){
		...
		try {
			...
			//org.dom4j.Node node = document.selectSingleNode("/license/module/"+moduleName.getName());
			//node.setText(licenseKey);
			
			Document document = DocumentHelper.createDocument();
			Element root = document.addElement("license");
			Element module = root.addElement("module").addAttribute("id", "1");
			Element bris = module.addElement("BRIS");
			bris.addText(licenseKey);
		 ...
		 * doc.getElementsByTagName("module").item(0);
		 * 
		 ...
		 * (moduleName.getName().equals(node.getNodeName())) {
	...
	public static String licenseFile(Module module){
		...
		try {
			if(xmlFile.exists()){
				...
				org.dom4j.Node node = document.selectSingleNode("/license/module/" + module.getName());
